...
def config_parser(cmd=None, return_parser=False):
    ...
    parser.add_argument('--model_name', type=str, default='PhasoRF',
                        choices=['PhasoRF', 'PhasoARF', 'PhasoDRF', 'PhasoMLP', 'CPhasoMLP'])
    ...
    parser.add_argument('--compute_extra_metric', type=bool, default=False)
    # training options
    # learning rate
    ...
    parser.add_argument("--TV_weight_density", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--TV_weight_density_reset", type=float, default=-1.0,
                        help='loss weight')
    parser.add_argument('--TV_weight_mean_curvature', type=int, default=0)
    parser.add_argument("--TV_weight_app", type=float, default=0.0,
                        help='loss weight')

    # model
    # volume options
    parser.add_argument("--TV_step", type=int, default=1)
    parser.add_argument("--den_num_comp", type=int, action="append")
    parser.add_argument("--app_num_comp", type=int, action="append")
    parser.add_argument("--app_dim", type=int, default=12)
    parser.add_argument("--app_ksize", type=int, default=12, 
                    help='appearance kernel size')
    parser.add_argument("--den_ksize", type=int, default=12, 
                    help='den kernel size') 
    parser.add_argument("--den_scale", type=float, default=1,
                    help='scale den')
    parser.add_argument("--app_scale", type=float, default=1,
                    help='scale app')
    parser.add_argument("--app_aug", type=str, default='none')
    parser.add_argument("--alpha_init", type=float, default=1e-3)
    parser.add_argument("--alpha_lr", type=float, default=1.)
    parser.add_argument("--scale_lr", type=float, default=1.)
    parser.add_argument("--update_dd", type=int, default=0)
    ...
    parser.add_argument("--softplus_beta", type=float, default=1,
                        help='beta the larger the beta the closer to relu')
    ...
    parser.add_argument("--update_tv_list", type=int, action="append")
